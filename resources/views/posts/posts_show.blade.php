    ...
    <div style="margin-top: 0; padding-top: 0;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <h3 style="margin: 0; padding: 0;">
                <b><a href="{{route('users.show', ['user' => $post->postable_id])}}">{{$post->postable->name}}</a></b>
            </h3>
        ...
        @foreach($comments as $comment)
            <li style="display: flex; justify-content: space-between; align-items: center;">
                <div style="flex-grow: 1;">
                    ...
                    <p><a href="{{route('users.show', ['user' => $comment->commentable_id])}}"><b>{{$comment->commentable->name}}</b></a></p>
                    <p>{{ $comment->comment }}</p>

                    <!-- Display albums attached to the comment -->
                    ...
                    <!-- Display songs attached to the comment -->
